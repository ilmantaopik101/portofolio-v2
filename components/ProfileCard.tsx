...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group cursor-pointer w-[320px] mx-auto">
        <section
          ...
          onMouseEnter={e => {
            ...
            e.currentTarget.style.transform = 'translateZ(0) rotateX(var(--rotate-y)) rotateY(var(--rotate-x)) scale(1.02)';
          }}
          onMouseLeave={e => {
            const shell = shellRef.current;
            ...
            >
              <img
                ...
                style={{
                  ...
                  transform:
                    'translateX(calc(-50% + (var(--pointer-from-left) - 0.5) * 6px)) translateZ(0) scaleY(calc(1.05 + (var(--pointer-from-top) - 0.5) * 0.02)) scaleX(calc(1.05 + (var(--pointer-from-left) - 0.5) * 0.01))',
                  borderRadius: cardRadius,
                  backfaceVisibility: 'hidden'
                }}
                onError={e => {
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  ...
                  style={{
                    ...
                    color: '#000000', // Warna Teks Nama (Putih Solid)
                    display: 'block',
                    gridArea: 'auto',
                    borderRadius: '0',
                    pointerEvents: 'auto'
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '16px',
                    margin: '0 auto',
                    color: '#000000', // Warna Teks Title (Biru Muda Solid)
                    display: 'block',
                    gridArea: 'auto',
                    borderRadius: '0',
                    pointerEvents: 'auto'
